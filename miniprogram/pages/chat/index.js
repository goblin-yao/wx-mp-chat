...
Page({
  ...
  data: {
    ...
    isVoiceInputStatus: app.getVoiceToggle() ? true : false, //语音模式默认为true，否则为false
   ...
   */
  stopVoice: function () {
    speechRecognizerManager && speechRecognizerManager.stop();
  ...
  onLoad: function (options) {
    ...
    wx.setNavigationBarTitle({
      title: decodeURIComponent(options.scenesText || "声语Pro"),
    });
    this.selectComponent("#chat_room").updatePromptInfo({
      promptType: options.promptType,
      scenesId: options.scenesId,
      scenesText: options.scenesText,
      promptText: "",
    });
